              ...
              <Card className="bg-black/40 border-green-500/30 backdrop-blur-sm">
                <div className="p-6">
                  ...
                  <div
                    ...
                    className="bg-black/60 p-4 rounded-lg h-96 overflow-y-auto font-mono text-sm border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <AnimatePresence>
