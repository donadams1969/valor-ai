                        ...
                        {signedManifest && (
                          ...
                          >
                            <div className="relative">
                              <pre
                                className="bg-black/60 text-xs p-4 rounded-lg max-h-64 overflow-auto border border-gray-700 focus-visible:ring-2 focus-visible:ring-blue-500 focus:outline-none"
                                tabIndex={0}
                                aria-label="Attestation JSON Details"
                              >
              ...
              <Card className="bg-black/40 border-green-500/30 backdrop-blur-sm">
                <div className="p-6">
                  ...
                  <div
                    ...
                    tabIndex={0}
                    className="bg-black/60 p-4 rounded-lg h-96 overflow-y-auto font-mono text-sm border border-gray-700 focus-visible:ring-2 focus-visible:ring-cyan-500 focus:outline-none"
                  >
                    <AnimatePresence>
