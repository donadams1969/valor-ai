            ...
            <TabsContent value="verification" className="mt-8">
              <Card className="bg-black/40 border-green-500/30 backdrop-blur-sm">
                <div className="p-6">
                  ...
                  <div
                    ref={logRef}
                    className="bg-black/60 p-4 rounded-lg h-96 overflow-y-auto font-mono text-sm border border-gray-700 focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:outline-none"
                    role="log"
                    aria-live="polite"
                    aria-label="Verification Logs Console"
                    tabIndex={0}
                  >
                    <AnimatePresence>
